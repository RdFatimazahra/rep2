...
void exitProgram(int *exitConfirmed) {
    int choice;
    ...
    if (choice == 1) {
        ...
        *exitConfirmed = 1;
        ...
        printf("Continuation du programme...\n");
        *exitConfirmed = 0;
    }
}
...
int main() {
	  ...
	  printf("\n");
	  printf("Bienvenue dans votre entrepot virtuel! ") ;
	  printf("\n");
    ...
    do {
        ...
        printf("*Choisissez l'operation voulue: \n");
        scanf("%d", &choice);
...
void displayStock(int numProducts) {
	...
	if (numProducts==0)
    	printf("le stock est vide, veuillez le remplir d'abord!\n");
    	else {
    printf("\nProduit du stock\n");
    printf("%-15s%-25s%-10s\n", "Code", "Noms", "Quantite");
